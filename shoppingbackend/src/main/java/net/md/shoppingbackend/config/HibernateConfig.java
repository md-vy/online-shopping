package net.md.shoppingbackend.config;
...
@Configuration
@ComponentScan(basePackages={"net.md.shoppingbackend.dto"})
...
public class HibernateConfig {
	...
	private final static String DATABASE_URL = "jdbc:mysql://onlineshopping-mysql:3306/onlineshopping";
	...
	public SessionFactory getSessionFactory(DataSource dataSource) {
		...
		builder.scanPackages("net.md.shoppingbackend.dto");
	...
	//All the hibenate properties will be returned in this method.
