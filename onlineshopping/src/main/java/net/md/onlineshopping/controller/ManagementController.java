...
import net.md.onlineshopping.util.FileUploadUtility;
import net.md.onlineshopping.validator.ProductValidator;
...
public class ManagementController {
	...
	@ResponseBody
	public String handlePorductActivation(@PathVariable int id) {
